...
export const FORM_PLACEHOLDER = 'http://tools-ai.xyz';

export const WEBSITE_EXAMPLE =
  '<a href="http://tools-ai.xyz" title="Tools-ai.xyz Tools Directory">AI Tools Diresctory</a>';
